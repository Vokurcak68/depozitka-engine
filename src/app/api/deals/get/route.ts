  ...
  return json(
    200,
    {
      ...
      deal: {
        ...
        initiatorName: deal.initiator_name || null,
        counterpartyEmail: deal.counterparty_email,
        counterpartyName: deal.counterparty_name || null,
        title: deal.title,
        description: deal.description,
        totalAmountCzk: deal.total_amount_czk,
        deliveryMethod: deal.delivery_method || null,
        shippingTerms: deal.shipping_terms || null,
        shippingCarrier: deal.shipping_carrier || null,
        shippingNote: deal.shipping_note || null,
        estimatedShipDate: deal.estimated_ship_date || null,
        termsAcceptedAt: deal.terms_accepted_at || null,
        termsVersion: deal.terms_version || null,
